...
train_model(naive_bayes.MultinomialNB(), 'Naive Bayes', X_data_tfidf_ngram, y_data_n)
train_model(linear_model.LogisticRegression(), 'Linear Classifier', X_data_tfidf_ngram, y_data_n)
train_model(svm.SVC(), 'Support Vector Machine', X_data_tfidf_ngram, y_data_n)
train_model(ensemble.RandomForestClassifier(), 'Bagging Model', X_data_tfidf_ngram, y_data_n)
train_model(xgboost.XGBClassifier(), 'Boosting Model', X_data_tfidf_ngram, y_data_n)
